public class Trie {
    ...
    public void insert(String word){
        ...
        System.out.println("Trie has been inserted");
    ...
    public boolean search(String word){
        ...
        if(currentNode.endOfString){
            System.out.println("Word: "+word+" is found in Trie");
            return true;
        }
        else{
            System.out.println("word "+word+" is prefix ");
    ...
    public boolean delete(TrieNode parentNode,String word,int index){
        ...
        // Time Complexity O(n2),Space Compexity O(n)
    }
